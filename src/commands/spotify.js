...
module.exports = class extends Command {
  ...
  async exec(message, { target }) {
    ...
    let status = target.user.presence.activities.find(
      (stf) => stf.name === "Spotify" && stf.type === "LISTENING"
    )

    if (!status)
      return message.channel.send("Cette personne n'écoute pas Spotify.")
    ...
    if (
      ...
      const embed = new MessageEmbed()
        ...
        .setFooter(
          "from Spotify",
          "https://i.pinimg.com/originals/fb/2c/4c/fb2c4cd83cf531f37381ed8e7b9ad1fc.png"
        )
